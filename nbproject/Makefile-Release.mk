...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalhopoo.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalhopoo.exe: ${OBJECTFILES}
...
${OBJECTDIR}/territory.o: territory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/territory.o territory.cpp
